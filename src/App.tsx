...
import Map, { MapRef } from '@/components/Maps'
...
function App() {
  ...
  const handleProvinceClick = (province: Province) => {
    ...
    if (mapRef.current) {
      mapRef.current.flyTo(province.coords, 12, {
        duration: 1.5
      });
    }
  };
